...
@dataclass
class ShuheLR(FairseqDataclass):
...
@register_lr_scheduler("shuhe_lr", dataclass=ShuheLR)
class ShuheLRSchedule(FairseqLRScheduler):
    ...
    def __init__(self, cfg: ShuheLR, optimizer):
